...
import { Image, Animated, Platform, StatusBar, StyleSheet, PanResponder, Text, View } from "react-native";
import Device from "../Utils/Device";

const { width, height } = Device.getScreenSize();
const isValidSize = height === 812 || width === 812 || (height === 896 || width === 896);
const statusBarHeight = Device.isIphoneX() ? (isValidSize ? 44 : 20) : StatusBar.currentHeight;

const TypeProps = {
  Warn: {
    source: require("../Assets/toastWarn.png"),
    color: "#cd853f"
  },
  Error: {
    source: require("../Assets/toastError.png"),
    color: "#cc3232"
  },
  Info: {
    source: require("../Assets/toastInfo.png"),
    color: "#2B73B6"
  },
  Success: {
    source: require("../Assets/toastSuccess.png"),
    color: "#32A54A"
  }
};

/**
 * @typedef {import("react-native-base").ToastProps} Props
 * @typedef {import("react-native-base").ToastState} State
